        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-8">
          ...
          <div className="sm:col-span-2 md:col-span-1 text-center">
            ...
            <div className="mb-4 flex justify-center">
              <Logo variant="large" size="lg" color="light" />
            </div>
            <p className="text-cream/50 text-xs leading-relaxed mx-auto max-w-[260px]">
            ...
            <a
              ...
              className="mt-3 inline-flex items-center justify-center w-9 h-9 rounded-full border border-cream/20 hover:bg-page/10 transition-colors"
            >
        ...
        <div className="border-t border-cream/10 mt-8 pt-5">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-xs">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-cream/40">
              ...
              <span className="hidden sm:inline text-cream/20">·</span>
              <span>ISO 9001 · ISO 14001 · ISO 29990</span>
            </div>
          </div>
        </div>
      </div>
